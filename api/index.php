 ...
 */
function handleDashboardData($input) {
    ...
    if ($compName) { $sqlEmp .= " AND C.CompanyFName = ?"; $paramsEmp[] = $compName; }
    if ($shiftName) { $sqlEmp .= " AND E.EmployeeId IN (" . implode(',', $shiftFilteredIds) . ")"; }
