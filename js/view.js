class AttendanceView {
    ...
    _renderGenderWise(logs, emps, empMap, model) {
        ...
        return {
            ...
            ${this._tableHTML(
                "tbl-gen",
                ["Gender", "Total", "Present", "Half Present", "Weekly Off", "Absent", "Rate",],
                rows,
                "gender-wise",
            )}
            <div id="drilldown-table" style="margin-top:16px"></div>
    ...
    _renderJoinExitTab(model, mode, page = 1) {
        ...
        this._lastData[exportKey] = items.map(({ emp }) =>
            isResigned ? {
                Code: emp.code, Name: emp.name, Dept: emp.dept, Company: emp.company,
                Designation: emp.designation, DOJ: emp.doj, DOR: emp.dor, Status: emp.status,
            } : {
                Code: emp.code, Name: emp.name, Dept: emp.dept, Company: emp.company,
                Designation: emp.designation, DOJ: emp.doj, Status: emp.status,
            },
        );
