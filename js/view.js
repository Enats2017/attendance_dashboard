class AttendanceView {
					...
					<div class="content-body">
                        ...
                        ${
                            state.activeTab === "age"
                                ...
                                ? this._renderLateInSummaryCards(stats,) : state.activeTab === "earlyout"
                                ? this._renderEarlyOutSummaryCards(stats,) : state.activeTab === "shift"
    ...
    /* ============================================================
   YEH SIRF _renderAgeSummaryCards() METHOD KA FIXED VERSION HAI.
   Apni AttendanceView.js mein _renderAgeSummaryCards() method ko
   neeche diye gaye is poore method se REPLACE kar dein.
   ============================================================

   KYA BADLA:
   1. `counts` ab sirf Present + Half Present din count karta hai
      (Absent / Weekly Off exclude kiye gaye hain), _matchesStatus()
      helper se filter laga kar.
   2. "Total Headcount" card ab `stats.total` (total employees) ki
      jagah sab age-groups ke Present+Half counts ka SUM dikhata hai.
   ============================================================ */
